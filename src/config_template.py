...
HAVE_SD      = True               # The PCB has an sd card inserted (or an sd card is connected otherwise)
...
SENSORS = "id battery aht20 mcp9808 ltr559"             # list of sensors. Each needs a <sensor>.py file

SHOW_UNITS = False # Show units in the csv output

# Logger identification constants
LOGGER_NAME  = 'Darasa Kamili'  # Perfect Classroom
LOGGER_ID    = '004'            # Change this to your logger id
